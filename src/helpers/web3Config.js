...
const Web3RpcCalls = {
  ...
  eth_getBlockTransactionCountByHash: {
    ...
    curl: calls.curl.default.eth_getBlockTransactionCountByHash,
  },
  eth_getBlockTransactionCountByNumber: {
    ...
    curl: calls.curl.default.eth_getBlockTransactionCountByNumber,
  },
  eth_getUncleCountByBlockHash: {
    ...
    curl: calls.curl.default.eth_getUncleCountByBlockHash,
  },
  eth_getUncleCountByBlockNumber: {
    ...
    curl: calls.curl.default.eth_getUncleCountByBlockNumber,
  },
  eth_getCode: {
    description: 'Returns code at a given address.',
    web3: calls.web3.default.eth_getCode,
    ethers: calls.ethers.default.eth_getCode,
    curl: calls.curl.default.eth_getCode,
  },
  eth_sign: {
    disabled: true,
    ...
    curl: calls.curl.default.eth_sign,
  },
  eth_signTransaction: {
    disabled: true,
    description: '🚫 This method is not supported in EtherFlow!',
    ...
    curl: calls.curl.default.eth_signTransaction,
  },
  eth_sendTransaction: {
    disabled: true,
    description: '🚫 This method is not supported in EtherFlow!',
    ...
    curl: calls.curl.default.eth_sendTransaction,
  },
  eth_sendRawTransaction: {
    ...
    curl: calls.curl.default.eth_sendRawTransaction,
  },
  eth_call: {
    ...
    curl: calls.curl.default.eth_call,
  },
  eth_estimateGas: {
    disabled: true,
  ...
  eth_getTransactionByHash: {
    ...
    curl: calls.curl.default.eth_getTransactionByHash,
  },
  eth_getTransactionByBlockHashAndIndex: {
    ...
    curl: calls.curl.default.eth_getTransactionByBlockHashAndIndex,
  },
  ...
  eth_getUncleByBlockHashAndIndex: {
    ...
    curl: calls.curl.default.eth_getUncleByBlockHashAndIndex,
  },
  eth_getUncleByBlockNumberAndIndex: {
    ...
    curl: calls.curl.default.eth_getUncleByBlockNumberAndIndex,
  },
  eth_getCompilers: {
    ...
    curl: calls.curl.default.eth_getCompilers,
  },
  eth_compileSolidity: {
    ...
    curl: calls.curl.default.eth_compileSolidity,
  },
  eth_compileSerpent: {
    ...
    curl: calls.curl.default.eth_compileSerpent,
  },
  eth_newFilter: {
    description:
    ...
    curl: calls.curl.default.eth_newFilter,
  },
  eth_newBlockFilter: {
    description:
    ...
    curl: calls.curl.default.eth_newBlockFilter,
  },
  eth_newPendingTransactionFilter: {
    ...
    curl: calls.curl.default.eth_newPendingTransactionFilter,
  },
  eth_uninstallFilter: {
    disabled: true,
    description: '🚫 This method is not YET supported in EtherFlow!',
    ...
    curl: calls.curl.default.eth_uninstallFilter,
  },
  eth_getFilterChanges: {
    ...
    curl: calls.curl.default.eth_getFilterChanges,
  },
  eth_getFilterLogs: {
    disabled: true,
    description:
    ...
    curl: calls.curl.default.eth_getFilterLogs,
  },
  eth_getLogs: {
    disabled: true,
    description:
    ...
    curl: calls.curl.default.eth_getLogs,
  },
  eth_getWork: {
    description:
    ...
    curl: calls.curl.default.eth_getWork,
  },
  trace_block: {
    description:
    ...
    curl: calls.curl.default.trace_block,
  },
  trace_transaction: {
    description:
    ...
    curl: calls.curl.default.trace_transaction,
  },
  trace_get: {
    description:
    ...
    curl: calls.curl.default.trace_get,
  },
  trace_rawTransaction: {
    ...
    curl: calls.curl.default.trace_rawTransaction,
  },
  trace_replayBlockTransactions: {
    ...
    curl: calls.curl.default.trace_replayBlockTransactions,
  },
  trace_replayTransaction: {
    ...
    curl: calls.curl.default.trace_replayTransaction,
  },
  trace_filter: {
    ...
    curl: calls.curl.default.trace_filter,
  },
  trace_call: {
    description:
    ...
    curl: calls.curl.default.trace_call,
  },
};
